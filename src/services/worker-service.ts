...
export class WorkerService {
  ...
  private registerRoutes(): void {
    ...
    this.server.registerRoutes(new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.sessionEventBroadcaster, this, this.openAICompatibleAgent /* fork */));
