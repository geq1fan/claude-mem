    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          // === Fork: OpenAI Compatible Configuration ===
          ...
          CLAUDE_MEM_OPENAI_COMPATIBLE_BASE_URL: data.CLAUDE_MEM_OPENAI_COMPATIBLE_BASE_URL || DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPATIBLE_BASE_URL,
